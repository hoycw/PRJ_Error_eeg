plt_vars.plt_lim    = [-0.2 1.3];
plt_vars.x_step_sz  = 0.20;
plt_vars.legend     = 1;
...
%plt_vars.plot_avg  = 0;
%plt_vars.sig_type  = 'patch';
%plt_vars.sig_color = [0.5 0.5 0.5];
%plt_vars.sig_alpha = 0.3;
%plt_vars.sig_style = '-';
...
plt_vars.evnt_type  = {'S','R','F'};
plt_vars.evnt_width = [2 2 2];
plt_vars.evnt_color = {'k','k','k'};
plt_vars.evnt_style = {'-','--','-'};
