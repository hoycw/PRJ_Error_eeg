function SBJ06a_CPA_topographs(SBJ, proc_id, gen_figs, fig_vis)
...
cfg           = [];
cfg.unmixing  = icaunmixing_tt;
cfg.topolabel = icatopolabel_tt;
...
%% Save Data
clean_data_fname = [SBJ_vars.dirs.preproc SBJ '_' proc_id '_02a_tt.mat'];
