function SBJ06e_OB_TT_ERP_plot_stats_corr_ts(SBJ_id,tt_proc_id,stat_id,plt_id,save_fig,varargin)
%% Plots group TT ERPs with OB ERP correlations and significance
% INPUTS:
