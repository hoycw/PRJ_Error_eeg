function [bhv] = fn_load_rating_behav_csv(csv_fname)
...
% Convert missing ratings to NaN
no_rating_idx = bhv.rating==-1;
bhv.rating(no_rating_idx) = nan([sum(no_rating_idx) 1]);
bhv.rating_rt(no_rating_idx) = nan([sum(no_rating_idx) 1]);
