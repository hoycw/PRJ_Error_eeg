function SBJ07b_CPA_candidate_ERP_plot_stack(SBJ,conditions,eeg_proc_id,cpa_id,an_id,plt_id,save_fig,varargin)
...
%% Plot Results
fig_dir = [root_dir 'PRJ_Error_eeg/results/CPA/candidate/' cpa_id '/' an_id '/' conditions '/' plt_id '/'];
