function SBJ08e_CPA_candidate_TFR_plot_stats_LME_RL_fits(SBJ_id,proc_id,cpa_id,an_id,stat_id,save_fig,varargin)
%% Plot group candiate IC TFRs per regressor: betas outlined by significance; + R2 plot
...
%% Load TFR for axes
load([root_dir 'PRJ_Error_eeg/data/' SBJs{1} '/04_proc/' SBJs{1} '_' proc_id '_' cpa_id '_' an_id '.mat']);
...
%% Plot Results
fig_dir = [root_dir 'PRJ_Error_eeg/results/CPA/' cpa_id '/' an_id '/' stat_id '/'];
...
%     end
    ...
    %% Create plot
    fig_name = [SBJ_id '_' stat_id '_' cpa_id '_' an_id '_' st_tfr.label{ch_ix}];
