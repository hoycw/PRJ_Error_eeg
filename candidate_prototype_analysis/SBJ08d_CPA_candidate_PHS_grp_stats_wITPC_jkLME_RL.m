function SBJ08d_CPA_candidate_PHS_grp_stats_wITPC_jkLME_RL(SBJ_id,proc_id,cpa_id,an_id,stat_id)
% Run weighted inter-trial phase coherence for phase at each time-frequency point
%   Jack-knife ITPC so get single trial values, then use LME RL regression
