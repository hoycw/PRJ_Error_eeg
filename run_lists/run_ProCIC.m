...
for an_ix = 1:numel(an_ids)
    for s = 1:numel(SBJs)
        ...
        SBJ06d_CPA_candidate_ERP_save(SBJs{s},eeg_proc_id,odd_proc_id,an_ids{an_ix},cpa_id);
        
        % Plot full TT epoch with trial stack
        plt_id    = 'stack_F2t1_evnt_c5';%'stack_S15to28_evnt_c5';
        SBJ06e_CPA_candidate_ERP_plot_stack(SBJs{s},conditions,eeg_proc_id,cpa_id,an_ids{an_ix},...
...
% %             plt_id,save_fig,'fig_vis',fig_vis,'fig_ftype',fig_ftype);
    ...
    % Group LME Stats
    SBJ06f_CPA_candidate_ERP_GRP_stats_LME_RL(SBJ_id,eeg_proc_id,cpa_id,an_ids{an_ix},stat_id);
    
    plt_id    = 'ts_F2to1_evnts_sigLine';
    SBJ06g_CPA_candidate_ERP_plot_LME_RL_fits(SBJ_id,eeg_proc_id,cpa_id,an_ids{an_ix},stat_id,...
        plt_id,save_fig,'fig_vis',fig_vis,'fig_ftype',fig_ftype);
