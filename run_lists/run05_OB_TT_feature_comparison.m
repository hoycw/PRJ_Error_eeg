...
% Feature selection:
%   After beta testing, group mean window of 50 ms was selected as most
%   robust option (feat_vars = 'N2sP3s_grpMW05')
%   TFR features were piloted, but results were mostly null using canonical
%   bands; maybe need better SNR or more tailored feature selection.
...
proc_id  = 'odd_full_ft';
feat_ids = {'N2sP3s_grpMW05'};  % see "Feature Combinations" below
...
% Unused TT Features:
%   Focus is on explaining the RL PE features instead of ERP peak features
