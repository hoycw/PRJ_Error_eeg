...
for s = 1:numel(SBJs)
    ...
    an_id     = 'ERP_Fz_S15t28_dm2t0_fl05t20';%,'ERP_Pz_S15t28_dm2t0_fl05t20'};
    plt_id    = 'stack_S15to28_evnt_c5';
    SBJ06b_CPA_plot_candidate_ERP_stack(SBJs{s},conditions,eeg_proc_id,odd_proc_id,an_id,stat_id,...
