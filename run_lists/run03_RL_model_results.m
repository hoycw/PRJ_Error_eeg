...
%   Fig. 2A/B/C/D and 6A/B: SBJ04c_ERP_grp_stats_LME_RL and SBJ04d_ERP_plot_stats_LME_RL_fits
%   Fig. 2E/2F: SBJ04e_ERP_plot_RL_model_comparison_ts
%   Fig. 3 and 6C/D: SBJ04c_ERP_grp_stats_LME_RL and SBJ04d_ERP_plot_stats_LME_RL_topo_ts_reg
%   Fig. 4 and 6E/F: SBJ05d_TFR_grp_stats_LME_RL and SBJ05e_TFR_plot_stats_LME_RL_fits
...
% Outcome models:
% stat_ids  = {'VML_DifFB_lme_st05t5','SML_DifFB_lme_st05t5'};
% RL models without uRPE or Lik:
% stat_ids  = {'EsRPEL_DifFB_lme_st05t5','ERPEs_DifFB_lme_st05t5'};
% All models for AIC comparisons:
...
%     SBJ04c_ERP_grp_stats_LME_SBJonly(SBJ_id,proc_id,an_ids{an_ix},null_id);
    ...
    %*** plots Fig. 2E and 2F
    %   mean_reg averages AIC within window based on regressor peak
    %   aic_mean_win averages AIC within manual window
    if contains(an_ids{an_ix},'Fz')
