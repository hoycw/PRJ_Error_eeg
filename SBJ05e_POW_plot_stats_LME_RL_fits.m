function SBJ05e_POW_plot_stats_LME_RL_fits(SBJs,proc_id,an_id,stat_id,plt_id,save_fig,varargin)
% Plots group single-band power with significance, also beta weights per regressor
...
for s = 1:length(SBJs)
    ...
    if numel(tfr.freq)>1; error([an_id ' has more than one frequency!']); end
