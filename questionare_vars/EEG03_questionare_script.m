...
Terrible, 9 = Great
%}
question_answers = {7,7,5,3,2,2};
% Response in answer to qustion: does the blue feedback reflect anything
% about your performance?
free_response = {'Thought of it as a random distraction. Because it was a distraction, he thought it messed up his next trial'};