...
question_answers = [8, 7, 7, 7, 7, 7];
% Response in answer to qustion: does the blue feedback reflect anything
% about your performance?
free_response = {'Not entirely random. They thought it was 50/50. Sometimes random and sometiems occuring when they got it right'};
