function SBJ04d_ERP_plot_stats_GLM_p2p_betas(SBJ_id,an_id,stat_id,plt_id,save_fig,varargin)
...
eval(stat_vars_cmd);
if ~strcmp(st.measure,'p2p') || ~strcmp(st.an_style,'glm'); error('run only for p2p GLM analyses!'); end
...
plot_betas = glm{1}.Coefficients.Estimate(2:end);
r2 = glm{1}.Rsquared.Adjusted;
