...
%--------------------------------------
SBJ_vars.SBJ = 'EEG16';
SBJ_vars.raw_file = {'eeg16.bdf'};
SBJ_vars.bhv_file = {'eeg16targettime_response_log_20191031174011.txt'};
SBJ_vars.oddball_file = 'eeg16_oddball_log_20191031172502.txt';
SBJ_vars.block_name = {''};
