...
%--------------------------------------
SBJ_vars.SBJ = 'EP19';
SBJ_vars.raw_file = {'Pilot19.bdf'};
SBJ_vars.bhv_file = 'Pilot19again_response_log_20190701180728.txt';
SBJ_vars.block_name = {''};
...
SBJ_vars.ch_lab.replace = {{'F4', 'EXG6'}}; % {{'final','EXG#'},{'final2','EXG#2'}}
SBJ_vars.ch_lab.prefix  = '1-';    % before every channel
SBJ_vars.ch_lab.suffix  = '';    % after every channel
SBJ_vars.ch_lab.trigger = 'Status';
SBJ_vars.ch_lab.bad     = {'TP8', 'Fp1', 'FT8', 'T8'};
SBJ_vars.ch_lab.null    = {'EXG7', 'EXG8'};
SBJ_vars.tt_trigger_ix = 3;
SBJ_vars.odd_trigger_ix = 10000;
SBJ_vars.trial_reject_ix = [10 135 149 154 156 163 330 363 513];
SBJ_vars.ica_reject = [1 4 5 6 7 9 10 15 18 19 20 24 25 26 28 29 32 34 35 37 38 40 41 44 45 46 47 49 50 51 52 54 56 57 58 59 60];
%Max around 600
%Max diff = 7ish
