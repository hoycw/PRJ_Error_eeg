...
SBJ_vars.trial_reject_ix = [32 223 224 426 427 428 478 238 562 569 585];
SBJ_vars.ica_reject = [1, 2, 3, 4, 5, 7, 8, 11, 12, 13, 14, 16, 17, 18, 19, 20, 23, 24, 28, 30, 34, 35, 36, 37, 39, 43, 45, 46, 47, 49, 50, 51, 52];
%Max around 700, 15
