...
%--------------------------------------
SBJ_vars.SBJ = 'EEG22';
SBJ_vars.raw_file = {'eeg22.bdf'};
SBJ_vars.bhv_file = {'eeg22_response_log_20191126172438.txt'};
SBJ_vars.oddball_file = 'eeg22_oddball_log_20191126170958.txt';
SBJ_vars.block_name = {''};
...
SBJ_vars.trial_reject_ix = [52, 111, 133, 181, 195, 203, 219, 322, 356, 358, 474, 518];
SBJ_vars.trial_reject_ix_oddball = [50, 54, 95, 130, 179, 374];
SBJ_vars.ica_reject = [ 1, 5, 6, 9, 11, 15, 19, 21, 22, 24, 26, 27, 28, 29, 30, 31, 33, 34, 37, 38, 41, 43, 46, 49, 50, 55, 56:65];
