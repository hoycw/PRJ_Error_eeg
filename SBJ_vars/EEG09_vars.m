...
%--------------------------------------
SBJ_vars.SBJ = 'EEG09';
SBJ_vars.raw_file = {'eeg09.bdf'};
SBJ_vars.bhv_file = {'eeg09_response_log_20190812175209.txt','eeg09_response_log_20190812175722.txt'};
SBJ_vars.oddball_file = {'EEG09_oddball_log_20190812163809.txt'};
SBJ_vars.block_name = {''};
...
SBJ_vars.trial_reject_ix = [87 329 349];
SBJ_vars.trial_reject_ix_oddball = [97, 150, 151, 152, 224, 225];
