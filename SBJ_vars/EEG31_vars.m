...
%--------------------------------------
SBJ_vars.SBJ = 'EEG31';
SBJ_vars.raw_file = {'eeg31.bdf'};
SBJ_vars.bhv_file = 'eeg31_response_log_20200213162802.txt';
SBJ_vars.oddball_file = {'eeg31_oddball_log_20200213161345.txt'};
SBJ_vars.block_name = {''};
...
SBJ_vars.ch_lab.bad     = {'Iz', 'AF4', 'T8', 'EXG2'};
SBJ_vars.trial_reject_ix = [58, 95, 99, 114, 152, 194, 203, 204, 213, 248, 283, 297, 304, 307, 330, 331, 335, 344, 355, 362, 382];
SBJ_vars.trial_reject_ix_oddball = [180, 181, 187, 257, 258, 259, 261, 262, 359, 363, 364, 389, 332, 359, 363];
SBJ_vars.ica_reject = [1, 2, 5,13, 14, 15, 18, 20, 21, 22, 24, 25, 26, 28, 30, 31, 32, 35, 36, 37, 39, 40, 42, 43, 44, 45, 47, 52, 53, 54:61]; %12? 18?
SBJ_vars.odd_trigger_ix = 404;
SBJ_vars.tt_trigger_ix = 3;
%External 2 is really bad
%REALLY WEIRD IC COMPONENT
