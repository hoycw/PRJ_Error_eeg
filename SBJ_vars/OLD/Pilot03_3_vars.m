...
SBJ_vars.dirs.SBJ     = ['/Users/SCS22/Desktop/Knight_Lab/Preprocessing_Work/' SBJ_vars.SBJ '/'];
data_out_filename_ICA = [SBJ_vars.dirs.SBJ 'Pilot03ICASorted' datestr(now,'mm-dd-yyyy HH-MM')];
data_out_filename_cleaned = [SBJ_vars.dirs.SBJ 'Pilot03clean' datestr(now,'mm-dd-yyyy HH-MM')];
...
SBJ_vars.dirs.raw_filename = strcat('/Users/SCS22/Desktop/Knight_Lab/Preprocessing_Work/', SBJ_vars.SBJ, '/', SBJ_vars.raw_file);
