...
%--------------------------------------
SBJ_vars.SBJ = 'EEG08';
SBJ_vars.raw_file = {'eeg08.bdf'};
SBJ_vars.bhv_file = 'eeg08_response_log_20190809152412.txt';
SBJ_vars.oddball_file = {'eeg08_oddball_log_20190809150851.txt'};
SBJ_vars.block_name = {''};
