...
ft.feat_lab    = 'Lik';                      % Overall name of features to extract
...
ft.an_id       = 'ERP_Cz_F2t1_dm2t0_fl05t20';  % ERP analysis ID

ft.name        = {'Lik'};                 % name of each feature
ft.cond        = {'DifFB'};                 % trial condition to search for feature
ft.chan        = {'Cz'};                   % Channel to search for feature
