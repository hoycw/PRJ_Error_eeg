...
ft.feat_lab    = 'uRPE';                      % Overall name of features to extract
...
ft.name        = {'uRPE'};                 % name of each feature
...
ft.pk_an_id    = 'ERP_Pz_F2t1_dm2t0_fl05t20';            % an_id from which to get peak time
