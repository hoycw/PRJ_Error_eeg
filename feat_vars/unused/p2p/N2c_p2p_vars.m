...
ft.feat_lab    = 'N2c';                      % Overall name of features to extract
ft.measure     = 'p2p';                         % {'sbjPk','sbjMW','grpMW'}
...
ft.name        = {'N2c'};                 % name of each feature
ft.cond        = {'Tar'};                 % trial condition to search for feature
ft.chan        = {'Fz'};                   % Channel to search for feature
ft.lim         = {...
                  [0.15 0.27; 0.2 0.35]};        % Time range to search for feature
ft.pk_sign     = {...
                  [1; -1]};                     % polarity of the peak
