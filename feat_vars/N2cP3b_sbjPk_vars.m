...
ft.feat_lab    = 'N2cP3b';                      % Overall name of features to extract
...
ft.name        = {'N2c','P3b'};                 % name of each feature
ft.cond        = {'Tar','Tar'};                 % trial condition to search for feature
ft.chan        = {'Fz','Pz'};                   % Channel to search for feature
